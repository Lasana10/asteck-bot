...
const paymentReadiness = await paymentService.checkPawaPayAvailability();
console.log('AFAT_PAYMENT_READINESS', JSON.stringify({
  provider: 'pawapay',
  configured: paymentReadiness.configured,
  environment: paymentReadiness.environment,
  cameroon_available: paymentReadiness.cameroonAvailable,
  provider_status: paymentReadiness.status || null,

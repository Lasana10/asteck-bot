...
import { Crosshair, MapPinPlus, Navigation } from 'lucide-react';
 ...
 const submit=()=>{
  ...
  navigator.geolocation.getCurrentPosition(async pos=>{
    const {data,error}=await supabase.rpc('afat_submit_mapping_observation',{
      ...
      p_attributes:{device_heading:Number.isFinite(pos.coords.heading)?pos.coords.heading:null},p_media_paths:[],p_observed_at:new Date(pos.timestamp).toISOString(),
    });
    setBusy(false);

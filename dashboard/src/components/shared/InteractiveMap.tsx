...
export function InteractiveMap({
  incidents = [], tracks = [], routePath = [], checkpoints = [], atlasNodes = [], trackedVehicle = null,
  ...
  }, [allSignals, atlasNodes, checkpoints, hazardSignals, movementSignals, primaryVehicle, routePath, showInformal, vehicleSignals]);
